...
###########################
## 11.1 Time Series Data ##
###########################

url <- "http://jse.amstat.org/datasets/utility.dat.txt"
utility <- read.table(url, stringsAsFactors=FALSE)
utility
...
########################################
## 11.3 Exponential Forecasting Model ##
########################################
...
## Damped trend and automatic model selecction
...
## Seasonal factor and automatic model selecction
