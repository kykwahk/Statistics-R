...
(4-7.08)^2/7.08+(6-2.92)^2/2.92
pchisq(4.59, df=1, lower.tail=FALSE)
...
# [그림 12-6]
windows(width=7.0, height=5.5)
plot(km.fit, las=1, xlab="Days", ylab="Overall Survival Probability")
plot(km.fit, las=1, mark.time=TRUE, xlab="Days", ylab="Overall Survival Probability")

# [그림 12-7]
windows(width=7.0, height=5.5)
library(survminer)
ggsurvplot(km.fit, legend="none", xlab="Days", ylab="Overall Survival Probability")
ggsurvplot(km.fit, legend="none", censor=FALSE, xlab="Days", ylab="Overall Survival Probability")
...
ggsurvplot(km.group, pval=TRUE, conf.int=TRUE, legend.title="",
...
# [그림 12-10]
windows(width=7.0, height=5.5)
ggsurvplot(km.group, conf.int=TRUE, legend.title="",
...
# [그림 12-16]
windows(width=7.0, height=5.5)
ggsurvplot(sex.fit, conf.int=FALSE, ggtheme=theme_light(), 
           legend.labs=c("Male", "Female"), legend.title="",
...
# [그림 12-17]
windows(width=7.0, height=5.5)
ggsurvplot(ph.fit, conf.int=FALSE, ggtheme=theme_gray(), 
