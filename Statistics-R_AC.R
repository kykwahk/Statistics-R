...
stargazer(mtcars, type="html", title="Descriptive Statistics", 
          digits=1, out="summary.html")

# [그림 C-2]
stargazer(mtcars, type="html", title="Descriptive Statistics", 
          digits=1, out="summary.html", flip=TRUE)
...
stargazer(mtcars[c("mpg", "hp", "wt")], summary=FALSE, 
          type="html", title="Car Information", out="data.html")
...
# [그림 C-6]
stargazer(m1, m2, m3, m4, type="html", title="Model Comparison", out="model.html")
...
# [그림 C-8]
stargazer(m1, m2, m3, type="html", title="Model Comparison", out="model.html",
          dep.var.labels=c("Miles per gallon"), 
          covariate.labels=c("Displacement (cu.in.)", "Rear axle ratio",
                             "Four gears", "Five gears"),
          omit.stat=c("LL", "ser", "f"), ci=TRUE, ci.level=0.95, single.row=TRUE)

stargazer(m1, m2, m3, type="text", title="Model Comparison", out="model.txt",
          dep.var.labels=c("Miles per gallon"), 
          covariate.labels=c("Displacement (cu.in.)", "Rear axle ratio",
                             "Four gears", "Five gears"),
          omit.stat=c("LL", "ser", "f"), ci=TRUE, ci.level=0.95, single.row=TRUE)
